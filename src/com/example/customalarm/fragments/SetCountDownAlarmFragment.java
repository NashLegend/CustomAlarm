        ...
        switch (v.getId()) {
            case R.id.hourButton:
                NumberPickerDialog.Builder builder = new NumberPickerDialog.Builder(
                        getActivity());
                NumberPickerDialog dialog1 = builder.setNumberSetListener(
                        new NumberPickerDialog.onNumberSetListener() {

                            @Override
                            public void onNumberSet(DialogInterface dialog, int num) {
            ...
            case R.id.minuteButton:
                NumberPickerDialog.Builder builder2 = new NumberPickerDialog.Builder(
                        getActivity());
                NumberPickerDialog dialog2 = builder2.setNumberSetListener(
                        new NumberPickerDialog.onNumberSetListener() {
